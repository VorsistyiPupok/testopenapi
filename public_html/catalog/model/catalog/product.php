...
class ModelCatalogProduct extends Model {
	...
	public function getCategoriesOnly($product_id) {
	    $query = $this->db->query("SELECT category_id FROM oc_product_to_category WHERE product_id = '" . (int)$product_id . "'");
		
		 return (string)$query->row['category_id'];
	}
